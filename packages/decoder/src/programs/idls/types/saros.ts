...
export type LiquidityBook = {
  ...
  instructions: [
    {
      ...
      discriminator: [6, 212, 14, 48, 229, 38, 62, 241];
      accounts: [
        {
    ...
    },
    {
      ...
      discriminator: [57, 125, 21, 59, 200, 137, 179, 108];
      accounts: [
        {
          name: "pair";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [253, 234, 128, 104, 192, 188, 45, 91];
      accounts: [
        {
          name: "pair";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [2, 168, 136, 251, 163, 9, 132, 255];
      accounts: [
        {
          name: "liquidityBookConfig";
        },
    ...
    {
      name: "initializePair";
      discriminator: [177, 114, 226, 34, 186, 150, 5, 245];
      accounts: [
        {
          name: "liquidityBookConfig";
        },
    ...
    },
    {
      ...
      discriminator: [115, 174, 34, 42, 176, 5, 229, 207];
      accounts: [
        {
          name: "liquidityBookConfig";
        },
    ...
    {
      name: "setHook";
      discriminator: [175, 16, 187, 252, 19, 54, 111, 221];
      accounts: [
        {
          name: "liquidityBookConfig";
          relations: ["pair"];
      ...
      accounts: [
        {
          name: "pair";
          writable: true;
          relations: ["binArrayLower", "binArrayUpper"];
        },
        {
          name: "tokenMintX";
          relations: ["pair"];
    ...
    },
    {
      ...
      discriminator: [205, 204, 206, 220, 251, 239, 19, 238];
      accounts: [
        {
          name: "liquidityBookConfig";
          relations: ["binStepConfig"];
        },
        {
          name: "binStepConfig";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [20, 223, 186, 73, 199, 65, 45, 80];
      accounts: [
        {
          name: "liquidityBookConfig";
          relations: ["pair"];
    ...
    },
    {
      ...
      discriminator: [42, 12, 208, 17, 29, 174, 196, 103];
      accounts: [
        {
          name: "liquidityBookConfig";
        },
  ...
  accounts: [
    ...
    {
      name: "binStepConfig";
      discriminator: [44, 12, 82, 45, 127, 124, 191, 199];
    },
    {
      name: "liquidityBookConfig";
      discriminator: [173, 36, 130, 129, 45, 178, 44, 86];
    },
    {
      name: "pair";
    ...
    {
      name: "quoteAssetBadge";
      discriminator: [183, 124, 99, 219, 110, 119, 157, 221];
    },
  ];
  events: [
    {
      name: "binArrayInitializationEvent";
      discriminator: [237, 158, 3, 184, 253, 238, 102, 71];
    },
    {
      name: "binStepConfigInitializationEvent";
      discriminator: [2, 138, 209, 132, 61, 232, 124, 57];
    },
    {
      name: "binStepConfigUpdateEvent";
      discriminator: [241, 69, 172, 53, 135, 27, 238, 248];
    },
    {
      name: "binSwapEvent";
      discriminator: [55, 42, 192, 194, 230, 243, 9, 72];
    },
    {
      name: "compositionFeesEvent";
      discriminator: [83, 234, 249, 47, 88, 125, 2, 86];
    },
    {
      name: "liquidityBookConfigInitializationEvent";
      discriminator: [90, 99, 66, 116, 24, 72, 145, 146];
    },
    {
      name: "liquidityBookConfigTransferOwnershipEvent";
      discriminator: [181, 131, 103, 224, 188, 170, 226, 65];
    },
    {
      name: "liquidityBookConfigTransferOwnershipInitEvent";
      discriminator: [69, 165, 109, 99, 223, 38, 229, 100];
    },
    {
      name: "pairInitializationEvent";
      discriminator: [132, 133, 209, 222, 229, 215, 206, 245];
    },
    {
      name: "pairStaticFeeParametersUpdateEvent";
      discriminator: [57, 109, 202, 252, 154, 9, 121, 131];
    },
    {
      name: "positionCreationEvent";
      discriminator: [97, 21, 205, 201, 62, 41, 111, 164];
    },
    {
      name: "positionDecreaseEvent";
      discriminator: [200, 116, 151, 126, 182, 237, 245, 254];
    },
    {
      name: "positionIncreaseEvent";
      discriminator: [247, 40, 58, 113, 28, 175, 60, 174];
    },
    {
      name: "protocolFeesCollectionEvent";
      discriminator: [196, 36, 190, 66, 172, 52, 142, 15];
    },
    {
      name: "quoteAssetBadgeInitializationEvent";
      discriminator: [202, 110, 93, 186, 165, 96, 200, 27];
    },
    {
      name: "quoteAssetBadgeUpdateEvent";
      discriminator: [102, 149, 171, 236, 123, 73, 205, 194];
    },
  ];
  errors: [
    {
